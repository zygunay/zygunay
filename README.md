```
  ...
  `@@@@@@@@@@@@@@@@@@p           |||     - About -----------------------------------------
   ...
   @@j*^`             `! L`':!    ||     . Experience: ..... IT Technician Intern & Developer @ LAV
   @@ lp;.,  / @@    ,:\nmy "  ,~ ||     
   @@ @@@@mmHM @@@@ ^****M*,p ,;  ||     - Tech Stack ------------------------------------
   @@ @@@HHH}g@M%%%%%H,jmgpmb%  j ||     . Languages: ...... C#, PHP, Kotlin, Python, C++, JavaScript
   @@ ;%%%%k@[,[.n|;.,j%%k%%%',|  ||     . Frameworks: ..... ASP.NET, Laravel, NestJS, React, Bootstrap
